...
namespace FYPmanager
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-3KB7QVM\SQLEXPRESS;Initial Catalog=SEPROJECT;Integrated Security=True");
        ...
        protected void sTable_SelectedIndexChanged(object sender, EventArgs e)
        {
